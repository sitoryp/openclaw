...
function resolveAnthropicDefaultAuthMode(cfg: IdleHandsConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: IdleHandsConfig): IdleHandsConfig {
...
export function applyTalkApiKey(config: IdleHandsConfig): IdleHandsConfig {
...
export function applyTalkConfigNormalization(config: IdleHandsConfig): IdleHandsConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: IdleHandsConfig): IdleHandsConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: IdleHandsConfig): IdleHandsConfig {
...
export function applyLoggingDefaults(cfg: IdleHandsConfig): IdleHandsConfig {
...
export function applyContextPruningDefaults(cfg: IdleHandsConfig): IdleHandsConfig {
...
export function applyCompactionDefaults(cfg: IdleHandsConfig): IdleHandsConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
