...
import { resolveIdleHandsAgentDir } from "../../agents/agent-paths.js";
...
import { ensureIdleHandsModelsJson } from "../../agents/models-config.js";
...
export async function loadModelRegistry(cfg: IdleHandsConfig) {
