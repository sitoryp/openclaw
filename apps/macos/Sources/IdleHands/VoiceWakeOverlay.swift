...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.idlehands", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other IdleHands windows, but below the system’s pop-up menus.
