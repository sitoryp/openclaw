...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .idlehandsSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? IdleHandsPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? IdleHandsPaths.stateDirURL.path
...
extension Notification.Name {
    static let idlehandsSelectSettingsTab = Notification.Name("idlehandsSelectSettingsTab")
}
