...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.idlehands", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("IdleHands/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__idlehands__/a2ui/").absoluteString + "?platform=macos"
    }
