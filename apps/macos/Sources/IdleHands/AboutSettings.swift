...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/idlehands/idlehands") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/idlehands/idlehands")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://idlehands.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "IdleHandsBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "IdleHandsBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "IdleHandsGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "IdleHandsGitCommit") as? String) ??
            "unknown"
    }
