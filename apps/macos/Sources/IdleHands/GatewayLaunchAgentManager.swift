...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.idlehands", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".idlehands/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.idlehandsCommand(
            subcommand: "gateway",
