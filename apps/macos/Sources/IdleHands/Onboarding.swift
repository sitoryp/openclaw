...
enum UIStrings {
    static let welcomeTitle = "Welcome to IdleHands"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "idlehands.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: IdleHandsChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g idlehands@\(version)"
    }
