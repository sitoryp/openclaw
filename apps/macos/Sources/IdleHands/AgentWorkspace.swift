...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.idlehands", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return IdleHandsConfigFile.defaultWorkspaceURL() }
