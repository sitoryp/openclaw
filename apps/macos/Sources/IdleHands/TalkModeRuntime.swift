...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.idlehands", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.idlehands", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [IdleHandsChatMessage] = messages.compactMap { item in
