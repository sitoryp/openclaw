...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: IdleHandsProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": IdleHandsProtocol.AnyCodable("start"),
                "name": IdleHandsProtocol.AnyCodable("bash"),
            ],
            summary: nil)
