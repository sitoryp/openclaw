...
/// Menu contents for the IdleHands menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About IdleHands") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "IdleHands Not Configured"
        case .remote:
            "Remote IdleHands Active"
        case .local:
            "IdleHands Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .idlehandsSelectSettingsTab, object: tab)
        }
    }
