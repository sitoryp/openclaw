...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = IdleHandsConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = IdleHandsConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = IdleHandsConfigFile.loadDict()
            ...
            IdleHandsConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/idlehands"
        state.remoteCliPath = ""
        return state
    }
}
