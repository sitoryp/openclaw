...
enum IdleHandsConfigFile {
    private static let logger = Logger(subsystem: "ai.idlehands", category: "config")
    ...
    static func stateDirURL() -> URL {
        IdleHandsPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        IdleHandsPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-idlehands-config-file",
            "event": "config.write",
