...
import ai.idlehands.android.ui.mobileSurface
import ai.idlehands.android.ui.mobileText
import ai.idlehands.android.ui.mobileTextSecondary
import ai.idlehands.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.idlehands.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.idlehands.android.ui.mobileFontFamily,
