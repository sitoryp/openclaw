...
import ai.idlehands.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("IdleHands is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
