...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: IdleHandsPhotosLatestParams) async throws -> IdleHandsPhotosLatestPayload {
        ...
        var results: [IdleHandsPhotoPayload] = []
        ...
        return IdleHandsPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> IdleHandsPhotoPayload
    {
