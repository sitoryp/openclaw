...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = IdleHandsLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = IdleHandsLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.idlehands.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected IdleHands agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while IdleHands is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for IdleHands. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(IdleHandsLocationMode.off.rawValue)
                            Text("While Using").tag(IdleHandsLocationMode.whileUsing.rawValue)
                            Text("Always").tag(IdleHandsLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while IdleHands is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("IdleHands", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = IdleHandsLocationMode(rawValue: newValue) else { return }
                Task {
