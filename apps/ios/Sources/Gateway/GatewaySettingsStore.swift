...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.idlehands.gateway"
    private static let nodeService = "ai.idlehands.node"
    private static let talkService = "ai.idlehands.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.idlehands.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.idlehands.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("idlehands-gateway.log")
    }
