...
public enum IdleHandsTalkCommand: String, Codable, Sendable {
...
public struct IdleHandsTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct IdleHandsTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
