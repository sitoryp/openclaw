...
public enum IdleHandsCanvasA2UICommand: String, Codable, Sendable {
...
public struct IdleHandsCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct IdleHandsCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
