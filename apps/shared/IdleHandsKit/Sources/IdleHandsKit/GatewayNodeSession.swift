...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.idlehands", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.idlehands", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: IdleHandsProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
