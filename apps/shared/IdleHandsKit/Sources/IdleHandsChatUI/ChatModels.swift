...
public typealias IdleHandsPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias IdleHandsPlatformImage = UIImage
#endif

public struct IdleHandsChatUsageCost: Codable, Hashable, Sendable {
...
public struct IdleHandsChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: IdleHandsChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(IdleHandsChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct IdleHandsChatMessageContent: Codable, Hashable, Sendable {
...
public struct IdleHandsChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [IdleHandsChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: IdleHandsChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [IdleHandsChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: IdleHandsChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(IdleHandsChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([IdleHandsChatMessageContent].self, forKey: .content) {
...
public struct IdleHandsChatHistoryPayload: Codable, Sendable {
...
public struct IdleHandsSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct IdleHandsSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [IdleHandsSessionPreviewItem]
}

public struct IdleHandsSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [IdleHandsSessionPreviewEntry]

    public init(ts: Int, previews: [IdleHandsSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct IdleHandsChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct IdleHandsChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct IdleHandsAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct IdleHandsChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct IdleHandsGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct IdleHandsPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: IdleHandsPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: IdleHandsPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct IdleHandsChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
