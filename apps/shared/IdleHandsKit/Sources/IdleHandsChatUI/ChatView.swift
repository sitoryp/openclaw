...
@MainActor
public struct IdleHandsChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: IdleHandsChatViewModel,
    ...
    private var visibleMessages: [IdleHandsChatMessage] {
        let base: [IdleHandsChatMessage]
    ...
    private func mergeToolResults(in messages: [IdleHandsChatMessage]) -> [IdleHandsChatMessage] {
        ...
        for message in messages {
            ...
            let merged = IdleHandsChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: IdleHandsChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: IdleHandsChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: IdleHandsChatMessage) -> String {
