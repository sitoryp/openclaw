...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = IdleHandsChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = IdleHandsChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
